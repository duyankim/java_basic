...
public class P11Q1 {
	...
	public static void main(String[] args) throws IOException {
		...
		File k03_f1 = new File("C:\\Users\\USER\\Desktop\\lesson08\\day_data\\A005930.csv");		// 작성할 csv파일을 경로로 설정함
		...
		while ((k03_readtxt = k03_br.readLine()) != null) {											// BufferedReader가 읽어온 라인이 null이 아닐 때까지 반복한다.
			...
			if (k03_field.length > 2 && k03_field[2].equals("A005930")) { 							// 필드의 길이가 2 이상일 때, 종목코드가 A로 시작할 때
				...
				for (int j=1; j<k03_field.length; j++) {											// 두 번째 field부터 마지막 field까지 반복해서  
					k03_s.append("," + k03_field[j]);												// 콤마를 넣은 뒤 ^를 제거한다.
				}
				k03_bw1.write(k03_s.toSting());													// 파일에 StringBuffer s를 쓴다.
