...
public class P11Q2 {
	...
	public static void main(String[] args) throws IOException {
		...
		File f1 = new File("C:\\Users\\USER\\Desktop\\lesson08\\day_data\\20150121.csv");		// 작성할 csv파일을 경로로 설정함
		...
		while ((readtxt = br.readLine()) != null) {												// BufferedReader가 읽어온 라인이 null이 아닐 때까지 반복한다.
			...
			if (field.length > 2 && field[1].equals("20150121")) { 								// 필드의 길이가 2 이상일 때, 종목코드가 A로 시작할 때
